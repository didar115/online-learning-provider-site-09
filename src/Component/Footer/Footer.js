  ...
  <footer className="py-5 ps-5">
    <div className="row">
      ...
      <div className="col-2">
        <h5>Apps</h5>
        <ul className="nav flex-column">
          <li className="nav-item mb-2"><Link to="/Home" className="nav-link p-0 ">Learn Python</Link></li>
          <li className="nav-item mb-2"><Link to="/Features" className="nav-link p-0 ">Learn Machine Learning</Link></li>
          <li className="nav-item mb-2"><Link to="/Pricing" className="nav-link p-0 ">Learning AI</Link></li>
          <li className="nav-item mb-2"><Link to="/FAQs" className="nav-link p-0 ">Learning Ruby </Link></li>
          <li className="nav-item mb-2"><Link to="/About" className="nav-link p-0 ">Learning Data Science</Link></li>
        </ul>
      </div>
    ...
    <div className="d-flex justify-content-center py-4 border-top ">
      <p>&copy; 2021, Inc. All rights reserved by senso coder.</p>
    </div>
  </footer>
</div>
   </div>
